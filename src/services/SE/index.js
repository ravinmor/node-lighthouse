...
export default {
    async metodo424EnvioDeCreditoDaAula(data) {
        const methodData = {
            ...
            tipoAula: data.tipoAula,                                  // "T" – Teórica, "A" – Atualização, "S" – Simulador, "P" – Prática, "E" – Especializado, "R" – Reciclagem
            ...
            creditoManual: data.creditoManual,                        // "S" – Sim, "N" – Não; Caso o parâmetro NÃO seja informado, considerar CREDITO-MANUAL = “N”
            ...
            aulaADistancia: data.aulaADistancia,                      // Deve ser informado “S” para aula à distância. Válido para aula teórica (“T”), atualização (“A”), especialização (“E”) e reciclagem (“R”). Obrigatório para os CFCs com aulas presenciais e remotas. Não obrigatório para CFCs EaD. 
            indiceVidAula: data.indiceVidAula,                        // 99999 - CASO O ÍNDICE DE VALIDAÇÃO BIOMÉTRICA SEJA INFERIOR A 85%, A AULA SERÁ CANCELADA E O CONDUTOR DEVERÁ RETORNAR AO DETRAN/SE
        }
        ...
        const response = await api.sendSOAPRequestSE(methodData);
        return{
            message: `--${message}--`,
            response: response
        };
