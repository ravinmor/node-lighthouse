...
export default {
    ...
    async connectSergipeHML() {
        ...
        const message = `${methodData.methodCode}${methodData.cfcCode}${methodData.cnhInstrutor}${methodData.cpfAluno}${methodData.dataAula}${methodData.cpfAluno}${methodData.horarioInicioAula}${methodData.horarioFimAula}${methodData.codigoMateria}${methodData.tipoAula}${methodData.categoriaPratica}${methodData.placaOuCodigoSimulador}${methodData.codigoCursoEspecializado}${methodData.nroAcertosProvas}${methodData.creditoManual}${methodData.cpfRespCreditoManual}${methodData.qtdeAulasSimuladorNoturnasPretendidas}${methodData.motivoCreditoManual}${methodData.aulaADistancia}${methodData.indiceVidAula}`;
